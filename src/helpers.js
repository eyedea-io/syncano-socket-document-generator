...
// In ES6 new Date('2017-07-19T00:00:00.000000Z').toLocaleDateString('en-GB', {day: '2-digit', month: '2-digit', year: 'numeric'}) returns "19/07/2017"
// In NodeJS new Date('2017-07-19T00:00:00.000000Z').toLocaleDateString('en-US', {day: '2-digit', month: '2-digit', year: 'numeric'}) returns "07/19/2017"
...
export default {
  ...
  isChecked: function () {
    return function (inputString, render) {
